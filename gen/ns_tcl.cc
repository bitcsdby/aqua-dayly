...
\"\n\
checkout_executable TCLSH \"/home/diaoboyu/ns-allinone-2.30/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/diaoboyu/ns-allinone-2.30/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
Mac/UnderwaterMac/BroadcastMac set packetheader_size_ 40 ;# 40 bytes\n\
